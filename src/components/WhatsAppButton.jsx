...
const WhatsAppButton = () => {
  ...
  const phoneNumber = '923252467463'; // Pakistan number without + (923252467463)
          ...
          <div className="absolute bottom-20 right-0 mb-2 w-80 bg-white rounded-2xl shadow-2xl overflow-hidden animate-fade-in-up">
            ...
            <div className="bg-gray-50 p-3 text-center text-xs text-gray-500 border-t border-gray-100">
              ...
              <div className="flex justify-center gap-4 mt-2">
                <a href="tel:03252467463" className="flex items-center gap-1 text-green-600 hover:text-green-700">
