...
import { ArrowRight, Star, Calendar, Tag, TrendingUp, Instagram, Quote, Award, Box, Printer, Layers, Gift, ShoppingBag, Package, Percent, Shield } from 'lucide-react';

import mainImg from '../../assets/shopping.jpg';
import galleryImg1 from '../../assets/shopping.jpg';
import galleryImg2 from '../../assets/specialcards.jpg';
import galleryImg3 from '../../assets/specialcerti.jpg';
import galleryImg4 from '../../assets/specialhigh.jpg';
import galleryImg5 from '../../assets/specialprinting.jpg';
import galleryImg6 from '../../assets/sticker1.jpg';
...
const RetailDisplayPackaging = () => {
  ...
  const results = [
    { icon: Percent, value: '68%', label: 'Increase in impulse purchases' },
    { icon: Shield, value: '85%', label: 'Reduction in product damage' },
    { icon: Star, value: '25', label: 'New retail partners' },
    { icon: TrendingUp, value: '40%', label: 'Customer returns decreased' }
  ];

  const expertServices = [
    { icon: Box, title: 'Structural Design', desc: 'Display box engineering' },
    { icon: Printer, title: 'Display Packaging', desc: 'Retail display design' },
    { icon: Layers, title: 'Digital Printing', desc: 'Vibrant printing' },
    { icon: Award, title: 'Die-Cutting', desc: 'Custom shapes' }
  ];

  const premiumProducts = [
    { icon: Package, title: 'Display Boxes', desc: 'Retail display boxes' },
    { icon: Box, title: 'Product Inserts', desc: 'Protective inserts' },
    { icon: Tag, title: 'Hang Tags', desc: 'Product tags' },
    { icon: Tag, title: 'Retail Labels', desc: 'Shelf labels' }
  ];
  ...
  const relatedProjects = [
    ...
    { title: 'Food Product Labels', category: 'Design', image: foodLabelsImg, path: '/portfolio/food-product-labels' }
  ];

  return (
    <div className="pt-20 overflow-x-hidden">
      <section className="relative min-h-[50vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0"><img src={mainImg} alt="Retail Display Packaging" className="w-full h-full object-cover" onError={(e) => { e.target.src = fallbackImage; }} /><div className="absolute inset-0 bg-gradient-to-r from-black/85 via-black/70 to-black/80"></div></div>
        <div className="container mx-auto px-4 relative z-10 py-20"><div className="max-w-3xl mx-auto text-center"><div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6"><Package className="w-4 h-4 text-yellow-500" /><span className="text-yellow-500 text-sm font-semibold">Packaging / Case Study</span></div><h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Retail <span className="text-yellow-500">Display Packaging</span></h1><p className="text-xl text-gray-300 mb-6 max-w-2xl mx-auto">Custom retail packaging that maximized shelf impact and sales conversion</p><div className="flex flex-wrap justify-center gap-6 text-center"><div><p className="text-gray-400 text-sm">Client</p><p className="text-white font-semibold">GiftCraft Pakistan</p></div><div><p className="text-gray-400 text-sm">Date</p><p className="text-white font-semibold">April 2024</p></div><div><p className="text-gray-400 text-sm">Category</p><p className="text-white font-semibold">Retail</p></div></div></div></div>
      </section>

      <section className="py-20 bg-white"><div className="container mx-auto px-4"><div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto"><div className="reveal"><span className="inline-block px-4 py-1 bg-red-100 text-red-600 rounded-full text-sm font-semibold mb-4">The Challenge</span><h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">What We Faced</h2><p className="text-gray-600 leading-relaxed">GiftCraft, a retailer of handmade crafts and gifts, needed display packaging that would protect products while showcasing them attractively in retail environments. Their plain boxes were being damaged during shipping and didn't help products stand out on crowded shelves.</p></div><div className="reveal"><span className="inline-block px-4 py-1 bg-red-100 text-red-600 rounded-full text-sm font-semibold mb-4">Our Solution</span><h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">How We Helped</h2><p className="text-gray-600 leading-relaxed">We designed custom retail display packaging with clear windows, sturdy construction, and vibrant printing. The packaging featured hang tabs for versatile display options, protective inserts, and clear product information. We used sustainable materials to align with their eco-friendly brand values while ensuring durability during transport and handling.</p></div></div></div></section>
      ...
      <section className="py-20 bg-gradient-to-r from-red-700 to-red-800"><div className="container mx-auto px-4"><div className="text-center mb-12 reveal"><h2 className="text-3xl md:text-4xl font-bold text-white mb-3">Results & <span className="text-yellow-500">Impact</span></h2></div><div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">{results.map((result, idx) => (<div key={idx} className="text-center reveal"><div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-3"><result.icon className="w-8 h-8 text-yellow-500" /></div><div className="text-3xl md:text-4xl font-bold text-white mb-1">{result.value}</div><div className="text-sm text-gray-300">{result.label}</div></div>))}</div><div className="mt-8 text-center"><div className="inline-block bg-white/10 backdrop-blur-sm rounded-2xl p-4 max-w-md mx-auto"><p className="text-white text-sm">🏆 Featured as supplier case study in Retail Pakistan magazine</p></div></div></div></section>
      ...
      <section className="py-20 bg-gray-50"><div className="container mx-auto px-4"><div className="max-w-3xl mx-auto text-center"><Quote className="w-12 h-12 text-red-400 mx-auto mb-6" /><p className="text-xl md:text-2xl text-gray-700 italic mb-6 reveal">"The new retail packaging solved two problems at once - protecting our delicate handmade items and making them irresistible on store shelves. Our retail partners love the professional look, and we've seen sales jump significantly."</p><div className="reveal"><h4 className="text-xl font-bold text-gray-800">Zainab Farooqi</h4><p className="text-red-600">Founder, GiftCraft Pakistan</p></div></div></div></section>
...
export default RetailDisplayPackaging;