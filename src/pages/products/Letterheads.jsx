...
import sample2 from '../../assets/banner.jpg';
import sample3 from '../../assets/book.jpg';
import sample4 from '../../assets/marksales.jpg';
...
const Letterheads = () => {
  ...
  const [mainImage, setMainImage] = useState(letterheadsImg);
  ...
  const getPriceRange = () => {
    switch(quantity) {
      case 100: return 'PKR 2,500 - 4,000';
      case 250: return 'PKR 5,000 - 8,000';
      case 500: return 'PKR 8,000 - 12,000';
      case 1000: return 'PKR 14,000 - 20,000';
      default: return 'PKR 2,500 - 4,000';
    }
  };
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="reveal">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                <span className="text-red-600">Letterheads</span>
              </h1>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Professional letterheads that add professionalism to your business correspondence. 
                Printed on high-quality paper with your brand elements. Perfect for official letters, 
                invoices, and company communications.
              </p>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-md mb-6">
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    { id: 'fullcolor', label: 'Full Color (CMYK)' },
                    { id: 'spot', label: 'Spot Color (Pantone)' }
                  ].map((option) => (
                    <button
                      key={option.id}
                      onClick={() => setSelectedPrint(option.id)}
                      className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 ${
                        selectedPrint === option.id 
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-10 reveal">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Detailed specifications for your letterheads</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 reveal">
              ...
              <ul className="space-y-2 text-gray-600 text-sm">
                ...
                <li>• Letter (11" x 8.5")</li>
                <li>• Legal (14" x 8.5")</li>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 reveal">
              ...
              <ul className="space-y-2 text-gray-600 text-sm">
                ...
                <li>• 120gsm Bond Paper</li>
                <li>• Watermarked Paper</li>
                <li>• Textured Linen / Laid Finish</li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 reveal">
              ...
              <ul className="space-y-2 text-gray-600 text-sm">
                <li>• Single-sided</li>
                <li>• Double-sided</li>
                <li>• Full color (CMYK)</li>
                <li>• Spot color (Pantone)</li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 reveal">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-3">Additional Options</h3>
              <ul className="space-y-2 text-gray-600 text-sm">
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { qty: 100, price: 'PKR 2,500 - 4,000' },
              { qty: 250, price: 'PKR 5,000 - 8,000' },
              { qty: 500, price: 'PKR 8,000 - 12,000' },
              { qty: 1000, price: 'PKR 14,000 - 20,000' }
            ].map((option, idx) => (
              <div key={idx} className="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 reveal">
                ...
                <div className="text-sm text-gray-500 mb-2">Sheets</div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-200 mb-8 reveal">
              Request a custom quote for Letterheads and we'll help you create something amazing.
            </p>
