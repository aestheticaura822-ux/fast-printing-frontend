...
import { 
  ...
  Lock, CornerDownRight, Hash, Maximize, Luggage, CaseSensitive
} from 'lucide-react';
...
import sample1 from '../../assets/rollup.jpg';
import sample2 from '../../assets/rollup1.jpg';
import sample3 from '../../assets/magine-cover.jpg';
...
const RollUpBanners = () => {
  ...
  const [mainImage, setMainImage] = useState(rollUpBannersImg);
  ...
  const getPriceRange = () => {
    switch(quantity) {
      case 1: return 'PKR 8,000 - 12,000';
      case 3: return 'PKR 22,000 - 33,000';
      case 5: return 'PKR 35,000 - 52,000';
      case 10: return 'PKR 65,000 - 95,000';
  ...
  return (
    <div className="pt-20 overflow-x-hidden bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="reveal">
              <div className="rounded-2xl overflow-hidden shadow-xl mb-4"><img src={mainImage} alt="Roll-Up Banners" className="w-full h-auto object-cover" onError={(e) => { e.target.src = fallbackImage; }} /></div>
            ...
            <div className="reveal">
              <div className="inline-flex items-center gap-2 bg-red-100 text-red-600 rounded-full px-3 py-1 text-sm font-semibold mb-4"><Star className="w-4 h-4 fill-red-600" /> Portable</div>
              <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">Roll-Up <span className="text-red-600">Banners</span></h1>
              <p className="text-gray-600 mb-6 leading-relaxed">Portable and professional roll-up banners ideal for trade shows, exhibitions, retail displays, and events. Easy to set up and transport with included carrying case. High-quality printing ensures your message stands out.</p>
              <div className="grid grid-cols-2 gap-3 mb-6">
                {['Retractable aluminum stand', 'Easy setup in seconds', 'Includes carrying case', 'High-resolution printing', 'Durable banner material', 'Fast 3-5 day turnaround'].map((feature, idx) => (<div key={idx} className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /><span className="text-sm text-gray-600">{feature}</span></div>))}
              </div>
      ...
      <section className="py-12 bg-white"><div className="container mx-auto px-4"><div className="text-center mb-10 reveal"><h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">Product <span className="text-red-600">Specifications</span></h2></div><div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gray-50 rounded-2xl p-6 reveal"><Ruler className="w-6 h-6 text-red-600 mb-3" /><h3 className="text-xl font-bold mb-3">Sizes</h3><ul className="space-y-1 text-gray-600 text-sm"><li>33" x 79" / 39" x 79"</li><li>47" x 79"</li><li>Custom sizes available</li></ul></div>
        <div className="bg-gray-50 rounded-2xl p-6 reveal"><Star className="w-6 h-6 text-red-600 mb-3" /><h3 className="text-xl font-bold mb-3">Stand Type</h3><ul className="space-y-1 text-gray-600 text-sm"><li>Retractable (Standard)</li><li>Premium / Deluxe</li><li>Economy Retractable</li></ul></div>
        <div className="bg-gray-50 rounded-2xl p-6 reveal"><Layers className="w-6 h-6 text-red-600 mb-3" /><h3 className="text-xl font-bold mb-3">Material</h3><ul className="space-y-1 text-gray-600 text-sm"><li>Premium vinyl banner</li><li>Fabric (wrinkle-free)</li><li>Blockout / Backlit material</li></ul></div>
        <div className="bg-gray-50 rounded-2xl p-6 reveal"><Package className="w-6 h-6 text-red-600 mb-3" /><h3 className="text-xl font-bold mb-3">Includes</h3><ul className="space-y-1 text-gray-600 text-sm"><li>Aluminum stand</li><li>Carrying case</li><li>Printed banner + Instructions</li></ul></div>
      </div></div></section>

      <section className="py-12 bg-gray-50"><div className="container mx-auto px-4"><div className="text-center mb-10 reveal"><h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">Pricing <span className="text-red-600">Options</span></h2></div><div className="grid md:grid-cols-4 gap-6">{[{ qty: 1, price: 'PKR 8,000 - 12,000' }, { qty: 3, price: 'PKR 22,000 - 33,000' }, { qty: 5, price: 'PKR 35,000 - 52,000' }, { qty: 10, price: 'PKR 65,000 - 95,000' }].map((option, idx) => (<div key={idx} className="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 reveal"><div className="text-3xl font-bold text-red-600 mb-2">{option.qty}</div><div className="text-sm text-gray-500 mb-2">Roll-Up Banners</div><div className="text-xl font-bold text-gray-800">{option.price}</div></div>))}</div><p className="text-center text-sm text-gray-500 mt-6">* Prices may vary based on customization options</p></div></section>
      ...
      <section className="py-20 bg-gradient-to-r from-red-700 to-red-800"><div className="container mx-auto px-4 text-center"><h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Get Started?</h2><p className="text-xl text-gray-200 mb-8">Request a custom quote for Roll-Up Banners and we'll help you create something amazing.</p><div className="flex flex-wrap justify-center gap-4"><Link to="/contact"><button className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold py-3 px-8 rounded-xl transition-all duration-300 hover:scale-105 shadow-xl flex items-center gap-2">Get Custom Quote <ArrowRight className="w-5 h-5" /></button></Link><Link to="/contact"><button className="border-2 border-white hover:bg-white hover:text-gray-900 text-white font-bold py-3 px-8 rounded-xl transition-all duration-300 hover:scale-105">Contact Us</button></Link></div></div></section>
    </div>
  );
};
