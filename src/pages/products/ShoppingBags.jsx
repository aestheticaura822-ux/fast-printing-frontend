...
import sample1 from '../../assets/shopping.jpg';
import sample2 from '../../assets/bagspouch.jpg';
import sample3 from '../../assets/box.jpg';
...
const ShoppingBags = () => {
  ...
  const [mainImage, setMainImage] = useState(shoppingBagsImg);
  ...
  const getPriceRange = () => {
    switch(quantity) {
      case 100: return 'PKR 10,000 - 18,000';
      case 250: return 'PKR 22,000 - 38,000';
      case 500: return 'PKR 40,000 - 70,000';
      case 1000: return 'PKR 75,000 - 130,000';
      default: return 'PKR 10,000 - 18,000';
    }
  };
  ...
  const relatedProducts = [
    ...
    { icon: Tag, title: 'Stickers', price: 'From PKR 2,500', desc: 'Custom stickers and labels for every need', image: labelsStickersImg, path: '/products/labels-stickers' },
  ...
  return (
    <div className="pt-20 overflow-x-hidden bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="reveal">
              <div className="rounded-2xl overflow-hidden shadow-xl mb-4"><img src={mainImage} alt="Shopping Bags" className="w-full h-auto object-cover" onError={(e) => { e.target.src = fallbackImage; }} /></div>
            ...
            <div className="reveal">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4">Shopping <span className="text-red-600">Bags</span></h1>
              <p className="text-gray-600 mb-6 leading-relaxed">Custom printed shopping bags that extend your brand beyond the store. Available in various materials, sizes, and handle options. Perfect for retail stores, boutiques, and special events.</p>
              <div className="grid grid-cols-2 gap-3 mb-6">
                {['Multiple material options', 'Various handle styles', 'Full-color printing', 'Reinforced handles', 'Eco-friendly options', 'Fast 7-10 day turnaround'].map((feature, idx) => (<div key={idx} className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-green-500" /><span className="text-sm text-gray-600">{feature}</span></div>))}
              </div>
      ...
      <section className="py-12 bg-white"><div className="container mx-auto px-4"><div className="text-center mb-10 reveal"><h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">Product <span className="text-red-600">Specifications</span></h2></div><div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gray-50 rounded-2xl p-6 reveal"><Layers className="w-6 h-6 text-red-600 mb-3" /><h3 className="text-xl font-bold mb-3">Materials</h3><ul className="space-y-1 text-gray-600 text-sm"><li>Kraft / Art paper</li><li>Non-woven fabric</li><li>Cotton / Jute / Plastic</li></ul></div>
        <div className="bg-gray-50 rounded-2xl p-6 reveal"><Ruler className="w-6 h-6 text-red-600 mb-3" /><h3 className="text-xl font-bold mb-3">Sizes</h3><ul className="space-y-1 text-gray-600 text-sm"><li>Small / Medium / Large</li><li>Extra Large</li><li>Custom sizes available</li></ul></div>
        <div className="bg-gray-50 rounded-2xl p-6 reveal"><ShoppingBag className="w-6 h-6 text-red-600 mb-3" /><h3 className="text-xl font-bold mb-3">Handle Options</h3><ul className="space-y-1 text-gray-600 text-sm"><li>Twisted paper / Flat paper</li><li>Rope / Ribbon / Cotton web</li><li>Die-cut handles</li></ul></div>
      ...
      <section className="py-12 bg-gray-50"><div className="container mx-auto px-4"><div className="text-center mb-10 reveal"><h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">Pricing <span className="text-red-600">Options</span></h2></div><div className="grid md:grid-cols-4 gap-6">{[{ qty: 100, price: 'PKR 10,000 - 18,000' }, { qty: 250, price: 'PKR 22,000 - 38,000' }, { qty: 500, price: 'PKR 40,000 - 70,000' }, { qty: 1000, price: 'PKR 75,000 - 130,000' }].map((option, idx) => (<div key={idx} className="bg-white rounded-2xl p-6 text-center shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 reveal"><div className="text-3xl font-bold text-red-600 mb-2">{option.qty}</div><div className="text-sm text-gray-500 mb-2">Bags</div><div className="text-xl font-bold text-gray-800">{option.price}</div></div>))}</div><p className="text-center text-sm text-gray-500 mt-6">* Prices may vary based on customization options</p></div></section>
      ...
      <section className="py-20 bg-gradient-to-r from-red-700 to-red-800"><div className="container mx-auto px-4 text-center"><h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Get Started?</h2><p className="text-xl text-gray-200 mb-8">Request a custom quote for Shopping Bags and we'll help you create something amazing.</p><div className="flex flex-wrap justify-center gap-4"><Link to="/contact"><button className="bg-yellow-500 hover:bg-yellow-600 text-gray-900 font-bold py-3 px-8 rounded-xl transition-all duration-300 hover:scale-105 shadow-xl flex items-center gap-2">Get Custom Quote <ArrowRight className="w-5 h-5" /></button></Link><Link to="/contact"><button className="border-2 border-white hover:bg-white hover:text-gray-900 text-white font-bold py-3 px-8 rounded-xl transition-all duration-300 hover:scale-105">Contact Us</button></Link></div></div></section>
    </div>
  );
};
