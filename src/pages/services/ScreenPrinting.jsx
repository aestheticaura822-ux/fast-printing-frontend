...
import { 
  ...
  Gift, CreditCard, Shirt, Tag, 
  ChevronRight, Layout, Newspaper, Package, Sparkles,
  ShoppingBag, MapPin, Briefcase,Shield, Palette
} from 'lucide-react';
...
import tshirtsImg from '../../assets/tshirt-printing.jpg';
import promotionalItemsImg from '../../assets/product-label0.jpg';
import signageImg from '../../assets/holo-sticker.jpg';
import postersImg from '../../assets/poster.jpg';
import stickersImg from '../../assets/sticker1.jpg';
...
const ScreenPrinting = () => {
  ...
  const features = [
    { icon: Layers, title: 'Material Versatility', desc: 'Print on fabric, plastic, metal, wood, glass, and more' },
    { icon: Shield, title: 'Superior Durability', desc: 'Screen printed designs withstand washing, weather, and wear' },
    { icon: Palette, title: 'Bold Colors', desc: 'Achieve vibrant, opaque colors that stand out' },
  ];

  const processSteps = [
    { number: '01', icon: Upload, title: 'Design Consultation', desc: 'Discuss your project and material requirements' },
    { number: '02', icon: Eye, title: 'Screen Preparation', desc: 'Create custom screens for your design' },
    { number: '03', icon: Palette, title: 'Color Mixing', desc: 'Mix custom inks to match your exact specifications' },
    { number: '04', icon: Printer, title: 'Printing', desc: 'Apply ink through screens onto your materials' },
    { number: '05', icon: CheckCircle, title: 'Curing & Quality Control', desc: 'Cure inks and inspect each piece for quality' },
  ];

  // Applications with images
  const applications = [
    { icon: Shirt, title: 'T-Shirts & Apparel', desc: 'Custom printed clothing for brands and events', image: tshirtsImg, color: 'from-blue-500 to-cyan-500' },
    { icon: Gift, title: 'Promotional Products', desc: 'Branded merchandise for marketing campaigns', image: promotionalItemsImg, color: 'from-purple-500 to-pink-500' },
    { icon: Layout, title: 'Signage', desc: 'Durable indoor and outdoor signs', image: signageImg, color: 'from-green-500 to-emerald-500' },
    { icon: Image, title: 'Posters', desc: 'Vibrant posters for events and advertising', image: postersImg, color: 'from-orange-500 to-red-500' },
    { icon: Tag, title: 'Stickers & Decals', desc: 'Custom stickers for branding and decoration', image: stickersImg, color: 'from-teal-500 to-cyan-500' },
    { icon: Briefcase, title: 'Industrial Marking', desc: 'Durable markings for industrial applications', image: industrialImg, color: 'from-pink-500 to-rose-500' },
  ];
  ...
  return (
    <div className="pt-20 overflow-x-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div>
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-yellow-500 text-sm font-semibold">Screen Printing Service</span>
              </div>
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
                Screen <span className="text-yellow-500">Printing</span>
              </h1>
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
                Vibrant, durable prints on various materials and surfaces
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="reveal">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                About <span className="text-red-600">Screen Printing</span>
              </h2>
              <p className="text-gray-600 mb-4 leading-relaxed">
                Screen printing, also known as silk screening, is a versatile printing technique that allows us to print on a wide variety of materials including fabric, plastic, metal, wood, and more. This method uses a mesh screen to transfer ink onto the substrate, creating vibrant, long-lasting prints.
              </p>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Screen printing is ideal for promotional items, apparel, signage, and any application requiring durability and bold colors. It's particularly cost-effective for larger quantities and excels at printing on non-paper materials where other printing methods fall short.
              </p>
            ...
            <div className="reveal">
              ...
              <div className="grid grid-cols-3 gap-4 mt-6">
                <div className="bg-red-50 rounded-xl p-4 text-center">
                  <Shirt className="w-8 h-8 text-red-600 mx-auto mb-2" />
                  <div className="text-2xl font-bold text-red-700">100+</div>
                  <div className="text-sm text-gray-600">Materials</div>
                </div>
                <div className="bg-red-50 rounded-xl p-4 text-center">
                  <Clock className="w-8 h-8 text-red-600 mx-auto mb-2" />
                  <div className="text-2xl font-bold text-red-700">7-10</div>
      ...
      {/* Why Choose Our Screen Printing Section */}
      <section className="py-20 bg-gradient-to-br from-red-900 via-red-800 to-red-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 reveal">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Why Choose Our <span className="text-yellow-500">Screen Printing</span>
            </h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
              Experience the difference with our premium screen printing services
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 reveal">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Discover the various ways our <span className="text-red-600">Screen Printing</span> can be utilized
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              From apparel to industrial marking, we've got you covered
            </p>
          </div>
