...
import { 
  ...
  Phone, Mail, MapPin, Building, GraduationCap,
  Book, FileText, IdCard, Lightbulb
} from 'lucide-react';

// Import images from assets folder
import customNotebooksImg from '../../assets/notebook.jpg';
import idCardsImg from '../../assets/business-card1.jpg';
import certificatesImg from '../../assets/specialcerti.jpg';
import prospectusesImg from '../../assets/letter.jpg';
import challengesImg from '../../assets/books.jpg';
import solutionsImg from '../../assets/lib.jpg';
import successStoryImg from '../../assets/specialcerti.jpg';
...
const Education = () => {
  ...
  const tailoredPoints = [
    { title: 'Educational Pricing', desc: 'Special volume discounts and educational pricing to fit school budgets' },
    { title: 'Bulk Planning', desc: 'Annual contracts ensuring timely delivery of all materials' },
    { title: 'Brand Templates', desc: 'Custom templates for consistent branding across campuses' },
    { title: 'Quality Assurance', desc: 'Premium quality materials that meet educational standards' }
  ];

  const popularProducts = [
    { icon: Book, title: 'Custom Notebooks', desc: 'Branded exercise books and notebooks for students', price: 'From PKR 4,000', image: customNotebooksImg, path: '/products/notepads' },
    { icon: IdCard, title: 'ID Cards', desc: 'Student and staff identification cards with security features', price: 'From PKR 5,000', image: idCardsImg, path: '/products/business-cards' },
    { icon: Award, title: 'Certificates', desc: 'Professional achievement and completion certificates', price: 'From PKR 5,000', image: certificatesImg, path: '/products/certificates' },
    { icon: FileText, title: 'Prospectuses', desc: 'High-quality brochures showcasing your institution', price: 'From PKR 8,000', image: prospectusesImg, path: '/products/brochures' }
  ];
    ...
    <div className="pt-20 overflow-x-hidden">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          >
            <source src="https://cdn.pixabay.com/video/2017/03/08/8256-207598612_medium.mp4" type="video/mp4" />
          </video>
        ...
        <div className="container mx-auto px-4 relative z-10 py-20 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-yellow-500 text-sm font-semibold">Schools & Education</span>
          </div>
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
            Empowering Education 
            <span className="text-yellow-500 block">Through Quality Printing</span>
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Specialized printing and packaging solutions for schools, colleges, universities, and educational institutions.
          </p>
          ...
          <div className="grid grid-cols-3 gap-6 mt-10 pt-6 border-t border-white/20 max-w-2xl mx-auto">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-yellow-500">150+</div>
      ...
      {/* Industry-Specific Expertise Section - Cards only, no image */}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 reveal">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-3">
              Specialized Solutions for <span className="text-red-600">Educational Institutions</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              From custom notebooks to certificates, we support the education sector with quality materials.
            </p>
          </div>
            ...
            <div className="reveal">
              ...
              <div className="space-y-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-800">Budget Constraints</h3>
                    <p className="text-gray-600 text-sm">Educational institutions often operate on tight budgets while requiring high-quality materials</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-800">Volume Requirements</h3>
                    <p className="text-gray-600 text-sm">Schools need large quantities of materials regularly, from admission forms to certificates</p>
                  </div>
                </div>
                <div className="flex gap-3">
                  <div className="w-6 h-6 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h3 className="font-bold text-gray-800">Brand Consistency</h3>
                    <p className="text-gray-600 text-sm">Maintaining consistent branding across all printed materials and multiple campuses</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12 reveal">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">
              Popular Products for <span className="text-red-600">Schools & Education</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Essential printing products tailored for educational institutions
            </p>
          </div>
      ...
      {/* Success Stories Section - Left Image, Right Both Schools */}
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="reveal">
            ...
            <div className="reveal">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                Real Impact for <span className="text-red-600">Educational Institutions</span>
              </h2>
              <div className="space-y-6">
                <div className="p-5 bg-gray-50 rounded-2xl">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">Karachi Grammar School</h3>
                  <p className="text-gray-600 text-sm mb-3">Complete stationery solution for 15 campuses across Pakistan</p>
                  <div className="inline-block bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-semibold">
                    30% cost reduction while improving quality and delivery times
                  </div>
                </div>
                <div className="p-5 bg-gray-50 rounded-2xl">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">Beaconhouse School System</h3>
                  <p className="text-gray-600 text-sm mb-3">Custom branded notebooks and ID cards for 50,000+ students</p>
                  <div className="inline-block bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-semibold">
                    Enhanced brand recognition and 99% on-time delivery rate
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-700 italic mb-6 reveal">
              "Fast Printing has been our trusted partner for over 5 years. Their understanding of educational needs and consistent quality make them invaluable to our institution."
            </p>
            <div className="reveal">
              <h4 className="text-xl font-bold text-gray-800">Dr. Ahmed Hassan</h4>
              <p className="text-red-600">Principal, City School</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-200 mb-8 reveal">
              Let's create printing and packaging solutions perfectly suited to your educational institution's needs
            </p>
